...
public sealed class NotifyTaskCompletion : INotifyPropertyChanged {
    ...
    public static NotifyTaskCompletion<TResult> Create<TResult>(Task<TResult> task, TResult defaultResult = default) {
    ...
    /// <param name="asyncAction">The asynchronous code to execute.</param>
    /// <param name="defaultResult">The default "result" value for the task while it is not yet complete.</param>
    public static NotifyTaskCompletion<TResult> Create<TResult>(Func<Task<TResult>> asyncAction, TResult defaultResult = default) {
...
public sealed class NotifyTaskCompletion<TResult> : INotifyPropertyChanged {
    ...
    /// </summary>
    public TResult Result => (Task.Status == TaskStatus.RanToCompletion) ? Task.Result : field;
